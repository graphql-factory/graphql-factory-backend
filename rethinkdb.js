...
function util (backend) {
  return {
    ...
    update: update$1.bind(backend),
    delete: del$1.bind(backend),
    exec: exec.bind(backend)
  };
}

// rethinkdb specific modules
var crud = { create: create, read: read, update: update, delete: del, initStore: initStore, filter: filter, util: util };
...
var GraphQLFactoryRethinkDBBackend = function (_GraphQLFactoryBaseBa) {
  ...
  function GraphQLFactoryRethinkDBBackend(namespace, graphql, factory, r, config, connection) {
    ...
    var _this = possibleConstructorReturn(this, (GraphQLFactoryRethinkDBBackend.__proto__ || Object.getPrototypeOf(GraphQLFactoryRethinkDBBackend)).call(this, namespace, graphql, factory, config, crud));
...
function index (namespace, graphql, factory, r, config, connection) {
